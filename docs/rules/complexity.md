...
This rule takes one option, an integer, which is the maximum cyclomatic complexity allowed.
...
If you can't determine an appropriate complexity limit for your code, then it's best not to enable this rule.
